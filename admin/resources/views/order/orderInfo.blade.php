    ...
    <div class="panel-body">
        ...
        <div class="panel-body">
            ...
            <div class="col-md-6 col-xs-6 col-sm-6 col-lg-4" >
                ...
                <p>Min Order :<?php echo $info->minOrder?></p>
                <p>Delivery Fee :<?php echo $info->delfee?></p>

            </div>
            <div class="col-md-6 col-xs-6 col-sm-6 col-lg-8" >
                <ul class="container details" >

                    <li><p><span class="fa fa-address-card-o" style="width:50px;"></span><?php echo $info->resAddress?>&nbsp;
                            <b>P.O :</b><?php echo $info->resZip?>&nbsp;
                            <b>City :</b><?php echo $info->resCity?></p>
                            <b>Country :</b><?php echo $info->resCountry?></p>
                    </li>
        ...
        <div class="panel-body">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12" >
                <ul class="container details" >
                    ...
                    <li><p><span class="fa fa-address-card-o" style="width:50px;"></span><?php echo $info->addressDetails?>&nbsp;
                            <b>P.O :</b><?php echo $info->addressZip?>&nbsp;
                            <b>City :</b><?php echo $info->addressCity?></p>
                        <b>Country :</b><?php echo $info->addressCountry?></p>
                    </li>
